let slider = document.querySelector('.slider'),
    ...
    sliderTrack = slider.querySelector('.slider-images'),
    slides = slider.querySelectorAll('.slider-hor-item'),
    btns = document.querySelector('.btns'),
    prev = btns.querySelector('.glo-slider__prev'),
    next = btns.querySelector('.glo-slider__next'),
    slideWidth = slides[0].offsetWidth,
    slideIndex = 0,
    posInit = 0,
    posX1 = 0, // начальная позиция курсора по оси Х
    posX2 = 0, //разность posX1 и event.clientX (posInit-posX1). Cмещение курсора по оси X, относительно его предыдущего положения
    posY1 = 0,
    posY2 = 0,
    posFinal = 0, //posFinal = posInit – posX1
    isSwipe = false,
    isScroll = false,
    allowSwipe = true,
    transition = true,
